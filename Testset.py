...
def image_classifaction_through_folder(directory):
    ...
    for root, _, files in os.walk(directory):
        ...
        for fileName in files:
            ...
            print("after classification:", "root: ", root, " filename:", fileName, "current pose being identified: ",
                  current_pose_directory, " identified pose: ", category, successful_count, total_count)
    print(categories, successful_count, total_count)
    return unsuccessful_classified

def main():
    directory = 'yoga poses/Test'
